...
public class UnityThinkGear2User extends UnityPlayerActivity {
	public static final String TAG = "UnityThinkGear2User";
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		UnityPlayer.UnitySendMessage("ThinkGear", "receiveRemoteKeyCode", ""+ keyCode);
		...
		public void handleMessage(Message msg) {
			...
			case TGDevice.MSG_STATE_CHANGE:
				...
				case TGDevice.STATE_CONNECTING:
					...
					UnityPlayer.UnitySendMessage("ThinkGear","receiveConnectState", connectState);
					break;
			...
			case TGDevice.MSG_POOR_SIGNAL:
				...
				UnityPlayer.UnitySendMessage("ThinkGear","receivePoorSignal", ""+poorSignalValue);
				break;
				
			case TGDevice.MSG_RAW_DATA:
				raw = msg.arg1;
				if(sendRawEnable){
					UnityPlayer.UnitySendMessage("ThinkGear","receiveRawdata", ""+raw);
				}
				break;
			...
			case TGDevice.MSG_ATTENTION:
				attention = (msg.arg1);
				if(sendESenseEnable){
					UnityPlayer.UnitySendMessage("ThinkGear","receiveAttention", ""+attention);
				}
				break;
			...
			case TGDevice.MSG_MEDITATION:
				meditation = (msg.arg1);
				if(sendESenseEnable){
					UnityPlayer.UnitySendMessage("ThinkGear","receiveMeditation", ""+meditation);
				}
				break;
			...
			case TGDevice.MSG_BLINK:
				blink = (msg.arg1);
				if(sendBlinkEnable){
					UnityPlayer.UnitySendMessage("ThinkGear","receiveBlink", ""+blink);
				}
				break;
			...
			case TGDevice.MSG_EEG_POWER:
				...
				if(sendEEGEnable){
					UnityPlayer.UnitySendMessage("ThinkGear","receiveDelta", ""+delta);
					UnityPlayer.UnitySendMessage("ThinkGear","receiveTheta", ""+theta);
					UnityPlayer.UnitySendMessage("ThinkGear","receiveLowGamma", ""+lowGamma);
					UnityPlayer.UnitySendMessage("ThinkGear","receiveLowBeta", ""+lowBeta);
					UnityPlayer.UnitySendMessage("ThinkGear","receiveLowAlpha", ""+lowAlpha);
					UnityPlayer.UnitySendMessage("ThinkGear","receiveHighGamma", ""+highGamma);
					UnityPlayer.UnitySendMessage("ThinkGear","receiveHighBeta", ""+highBeta);
					UnityPlayer.UnitySendMessage("ThinkGear","receiveHighAlpha", ""+highAlpha);
				}
			default:
				break;
			}
